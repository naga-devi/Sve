...
export class ProductDetailComponent implements OnInit {
    ...
    public getProductById(id) {
        this.appService.getBy(`product/productdetails/view/${id}`).subscribe(data => {
            this.product = data;
    ...
    getProductPriceByBrand(brandId) {
        if (this.product) {
            this.product.brands.forEach(x => {
                x.selected = brandId == x.id;
            });

            this.appService.getProductPrice(this.product.productBaseId, this.product.sizeId, brandId,this.product.materialTypeId,this.product.gradeId)
                .subscribe(data => {
